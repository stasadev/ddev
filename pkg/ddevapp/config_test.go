...
func TestConfigValidate(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Equal semver version with suffix (>)", "v1.22.3-11-g8baef014e", "> 1.22", "your DDEV version 'v1.22.3-11-g8baef014e' doesn't meet the constraint '> 1.22'"},
		...
		{"Greater", "v1.22.3", ">1.22.3", "your DDEV version 'v1.22.3' doesn't meet the constraint '>1.22.3'"},
		{"Greater prerelease", "v1.22.3-11-g8baef014e", ">1.22.3", ""},
		{"Greater than", "v1.22.3", ">=1.22.3", ""},
		{"Greater prerelease", "v1.22.3-11-g8baef014e", ">1.22.3", ""},
		{"Greater than prerelease", "v1.22.3-11-g8baef014e", ">=1.22.3", ""},
		{"Greater than prerelease with suffix (>)", "v1.22.3-11-g8baef014e", "> 1.22.3-10", ""},
		{"Greater than prerelease with suffix (>=)", "v1.22.3-11-g8baef014e", ">=1.22.3-11", ""},
		{"Greater than prerelease with suffix (<)", "v1.22.3-11-g8baef014e", "<1.22.3-12", ""},
		{"Greater than prerelease with suffix (<=)", "v1.22.3-11-g8baef014e", "<= 1.22.3-12", ""},
		{"Greater than prerelease with suffix fail", "v1.22.3-11-g8baef014e", ">=1.22.3-12", "your DDEV version 'v1.22.3-11-g8baef014e' doesn't meet the constraint '>=1.22.3-12'"},
		{"Extended condition", "v1.22.3", ">1.22.3 <1.22.4", "your DDEV version 'v1.22.3' doesn't meet the constraint '>1.22.3 <1.22.4'"},
		{"Extended condition equals", "v1.22.3", ">=1.22.3 <1.22.4", ""},
		{"Extended condition prerelease", "v1.22.3-11-g8baef014e", ">1.22.3, <1.22.4", ""},
		{"Extended condition equals prerelease", "v1.22.3-11-g8baef014e", ">=1.22.3 <1.22.4", ""},
		{"Extended condition OR", "v1.22.3", ">=1.22.3 <1.22.4 || 1.22.3", ""},
...
func TestTimezoneConfig(t *testing.T) {
	...
	validOutputs := []string{fmt.Sprintf("timezone=%s\nphptz=%s", hostTimezoneAbbr, hostTimezone)}
	if hostTimezoneAbbr == "UTC" {
		validOutputs = append(validOutputs, "timezone=Universal\nphptz=UTC")
	}
	require.Contains(t, validOutputs, inWebContainerTZData)
	...
	require.NoError(t, err)
	// Container's /etc/localtime may symlink to either UTC or Universal (both are equivalent)
	validTimezones := []string{fmt.Sprintf("timezone=%s", hostTimezoneAbbr)}
	if hostTimezoneAbbr == "UTC" {
		validTimezones = append(validTimezones, "timezone=Universal")
	}
